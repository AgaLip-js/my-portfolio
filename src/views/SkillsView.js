...
const StyledTitleR = styled.h2`
  ...
  margin: 0;
  padding: 0;
  animation: ${typingSec} 2s steps(30, end) 0.5s forwards, ${blinkCaret} 0.75s step-end infinite;
  animation-delay: 1s;
  @media (max-width: 1000px) {
    height: 30px;
    font-size: 16px;
    animation: ${typingSec2} 2s steps(30, end) 0.5s forwards, ${blinkCaret} 0.75s step-end infinite;
    animation-delay: 1s;
  }
`;
const StyledTitleL = styled(StyledTitleR)`
  animation: ${typing2} 2s steps(30, end) 0.5s forwards, ${blinkCaret} 0.75s step-end infinite;
  animation-delay: 1s;
  @media (max-width: 1000px) {
    animation: ${typing} 2s steps(30, end) 0.5s forwards, ${blinkCaret} 0.75s step-end infinite;
    animation-delay: 1s;
  }
`;
...
const StyledTimeline = styled.ul`
  ...
  ::before {
    ...
    background: linear-gradient(to bottom, rgb(231, 231, 231) 0%, rgb(17, 21, 23) 8%, rgb(17, 21, 23) 92%, rgb(231, 231, 231) 100%);
  }
  @media (max-width: 1000px) {
    width: 100%;
    margin: 0;
  ...
  return (
    <StyledWrapper>
      <StyledSkillsView className="skills" id={id} name={name} ref={myRef}>
        <StyledColumn>
          {state ? <StyledTitleL> My learning path </StyledTitleL> : <StyledTitle></StyledTitle>}
          <StyledTimeline>
            ...
            <SkillsIcon left icon={redux} styleI={{ height: '48px' }} aos={animL}>
              REDUX
            </SkillsIcon>
          </StyledTimeline>
        </StyledColumn>
        <StyledColumn>
          {state ? <StyledTitleR> My learning target </StyledTitleR> : <StyledTitle></StyledTitle>}
          <StyledTimeline>
            ...
            <SkillsIcon icon={sass} aos={animR}>
              SASS
            </SkillsIcon>
            <SkillsIcon left icon={reactnative} aos={animL}>
              REACT NATIVE
            </SkillsIcon>
            <SkillsIcon icon={nodeJS} aos={animR}>
              NODE JS
            </SkillsIcon>
            <SkillsIcon left icon={postgresql} styleI={{ height: '50px', width: '48px' }} aos={animL}>
              POSTGRESQL
            </SkillsIcon>
            <SkillsIcon icon={nextJS} styleI={{ height: '45px', width: '75px' }} aos={animR}>
              NEXT.JS
            </SkillsIcon>
            <SkillsIcon left icon={gatsby} aos={animL}>
              GATSBY.JS
            </SkillsIcon>
            <SkillsIcon styleT={{ width: '200px' }} aos={animR}>
